...
<head>
    ...
    <title>ChatConnect - Ultimate Final Version</title>
...
<body>
    ...
    <section id="section-security" class="section active-section">
        <div class="security-card">
            ...
            <p class="security-desc">
                Anda masuk sebagai pengguna baru.<br>
                Silakan verifikasi nomor telepon Anda dengan kode 2 langkah.
            </p>
            <div id="step1-phone">
                <div class="form-group" style="text-align: left;">
                    <label>Nomor Telepon</label>
                    <input type="tel" class="form-control" id="verifyPhone" placeholder="+62 812 XXXX XXXX">
                </div>
            ...
            <div id="step2-otp" style="display: none;">
                <div class="form-group" style="text-align: left;">
                    ...
                    <input type="text" class="form-control otp-input" id="verifyCode" placeholder="123456" maxlength="6">
    ...
    <div id="newChatModal" class="modal-overlay">
        <div class="modal-card">
            ...
            <div class="modal-body"><div class="form-group"><label>Cari Kontak / Masukkan Nomor</label><input type="text" id="newChatName" class="form-control" placeholder="Nama atau +62..."></div></div>
    ...
    <div id="cameraModal" class="modal-overlay">
        <div class="modal-card">
            <div class="modal-header"><span>Pilih Sumber Kamera</span><span style="cursor: pointer;" onclick="closeModal('cameraModal')">&times;</span></div>
            <div class="modal-body" style="display: grid; gap: 15px; grid-template-columns: 1fr 1fr 1fr;">
                <button class="btn btn-secondary" onclick="openCamera('front')"><i class="fas fa-user"></i><br><span style="font-size:0.8rem; margin-top:5px;">Kamera Depan</span></button>
                <button class="btn btn-secondary" onclick="openCamera('back')"><i class="fas fa-sync-alt"></i><br><span style="font-size:0.8rem; margin-top:5px;">Kamera Belakang</span></button>
                <button class="btn btn-secondary" onclick="document.getElementById('imgInput').click()"><i class="fas fa-images"></i><br><span style="font-size:0.8rem; margin-top:5px;">Galeri</span></button>
            </div>
        </div>
    </div>
    ...
    <div id="callModal" class="modal-overlay" style="background: rgba(0,0,0,0.8);">
        <div class="call-screen" style="text-align: center; color: white;">
            <img id="callAvatar" src="https://picsum.photos/seed/budi/150/150" class="call-avatar" style="width: 120px; height: 120px; border-radius: 50%; margin-bottom: 20px; border: 4px solid var(--white);">
            <h2 id="callName">Budi Santoso</h2>
            <p id="callStatus" class="call-status" style="font-size: 1.2rem;">Memanggil...</p>
            <div id="callTimer" class="call-timer" style="font-size: 2.5rem; margin-bottom: 30px; font-weight: bold;">00:00</div>
            <div class="call-actions" style="display: flex; gap: 20px; justify-content: center; margin-top: 20px;">
                <button class="call-btn btn-mute" style="width: 60px; height: 60px; border-radius: 50%; border: none; cursor: pointer; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; transition: 0.2s; background: rgba(255,255,255,0.2); color: white;" onclick="toggleMute()"><i class="fas fa-microphone-slash"></i></button>
                <button class="call-btn btn-end" style="width: 60px; height: 60px; border-radius: 50%; border: none; cursor: pointer; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; transition: 0.2s; background: var(--danger); color: white;" onclick="endCall()"><i class="fas fa-phone-slash"></i></button>
            </div>
        </div>
    </div>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <div class="nav-menu">
            ...
            <a onclick="showSection('account')" class="nav-item nav-subitem" id="nav-account"><i class="fas fa-key"></i> Akun</a>
            ...
            <a onclick="showSection('help')" class="nav-item nav-subitem" id="nav-help"><i class="fas fa-question-circle"></i> Bantuan</a>
    ...
    <main class="main-content">
                ...
                <div id="tab-chat" class="tab-content active">
                    <div class="search-bar-container">
                        <div class="search-input-wrapper">
                            ...
                            <input type="text" placeholder="Cari chat..." onkeyup="searchChat(this.value)">
                        </div>
                    </div>
            ...
            <div class="chat-window" id="chatWindow">
                <div class="chat-header">
                    ...
                    <div class="chat-header-actions">
                        ...
                        <i class="fas fa-ellipsis-v" onclick="showSection('account')"></i>
                    </div>
                </div>

                <div class="chat-messages" id="messageContainer">
                    <div class="message received">Halo, apa kabar? Lama tak jumpa!<div class="message-meta"><span>10:30</span></div></div>
                    <div class="message sent">Kabar baik! Kamu gimana?<div class="message-meta"><span>10:31</span><i class="fas fa-check read"></i><i class="fas fa-check read"></i></div></div>
                </div>
                ...
                <div class="chat-input-area">
                    ...
                    <button class="btn-icon" onclick="openCameraModal()"><i class="fas fa-camera"></i></button>
        ...
        <section id="section-account" class="section">
            ...
            <div class="card">
                ...
                <div class="form-group"><label>Nomor Telepon</label><input type="text" class="form-control" value="+62 812 3456 7890" disabled></div>
                <p style="font-size:0.8rem;color:var(--text-gray);margin-top:5px;">Nomor ini tidak dapat diubah demi keamanan.</p>
            </div>
        ...
        <section id="section-data" class="section">
            ...
            <div class="card">
                ...
                <div style="margin-top:10px; display:flex; flex-direction:column; gap:10px;">
                    <button class="btn btn-text" onclick="clearChat()"><i class="fas fa-trash"></i> Bersihkan Obrolan</button>
                    <button class="btn btn-text" onclick="exportChat()"><i class="fas fa-download"></i> Ekspor Chat (.txt)</button>
                </div>
            </div>
        </section>
    ...
    <script>
        ...
        function showSection(sectionId) {
            ...
            if(['account','notifications','privacy','data','help'].includes(sectionId)) openSettings(); else closeSettings();
        ...
        function searchChat(query) {
            ...
            for (let i = 0; i < items.length; i++) {
                const name = items[i].querySelector('h4').innerText.toLowerCase();
        ...
        function confirmCreateGroup() {
            ...
            newItem.onclick = function() {
                ...
                currentChatName.innerText = groupName; currentChatStatus.innerText = "Grup";
        ...
        function appendMessage(content, type) {
            ...
            else if(type === 'video') { contentHtml = `<video src="${content}" controls class="msg-video">Browser tidak mendukung video.</video><small style="margin-top:2px;display:block;">Video</small>`; }
            ...
            else if(type === 'doc') contentHtml = `<div style="display:flex;align-items:center;gap:10px;"><i class="fas fa-file-alt fa-2x"></i><div>${content}<br><small>10 KB</small></div></div>`;
        ...
        function openCamera(mode) {
            ...
            if (mode === 'front') { input.capture = 'user'; } else if (mode === 'back') { input.capture = 'environment'; }
            input.onchange = function(e) { handleImageUpload(e.target); };
            input.click();
        ...
        function toggleBlockUser() {
            ...
            const status = isBlocked ? 'Kontak diblokir.' : 'Kontak dibuka blokir.'; showToast(status);
